...
class ContentTools.ImageSelectDialog extends ContentTools.DialogUI
    constructor: ()->
        super('Select image')
        # If the dialog is populated, this is the URL of the image
        @_imageURL = null
    ...
    mount: () ->
        ...
        @_domUpload.textContent = ContentEdit._('Upload')
        domActions.appendChild(@_domUpload)
        # search input for image tags and name
        @_domInput = document.createElement('input')
        @_domInput.setAttribute('class', 'ct-image-dialog__file-search')
        @_domInput.setAttribute('name', 'file')
        ...
        @dispatchEvent(@createEvent('imageselector.mount'))
    ...
    unmount: () ->
        # Unmount the component from the DOM
        # TODO: verify the list of dom elements
        super()
        @_domCancelUpload = null
        @_domClear = null
        @_domCrop = null
        ...
        @dispatchEvent(@createEvent('imageselector.unmount'))
...
class ContentTools.ImageGalleryDialog extends ContentTools.DialogUI